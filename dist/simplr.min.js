...
defaultRules:["notempty"],defaultLabel:"_LABEL_",rules:{},labels:{},codes:{},validators:{}};simplr.form={addLabelAssociation:function(b){for(var a in b)simplr.dataStorage.form.labels[a]=b[a]},addValidationAssociation:function(b){for(var a in b)simplr.dataStorage.form.rules[a]=b[a]},addValidation:function(b){for(var a in b)simplr.dataStorage.form.validators[a]=b[a]},addCode:function(b){for(var a in b)simplr.dataStorage.form.codes[a]=b[a]},getValues:function(a){var c={};a=a&&"string"==typeof a?document.querySelector(a).querySelectorAll("input, select, textarea"):
